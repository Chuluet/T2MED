...
class _AddmedPageState extends State<AddmedPage> {
  ...
  void initState() {
    super.initState();
    // La inicialización de notificaciones se hace globalmente después del login
  }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _label("Dosis"),
              _buildInputField(_dosisController, 'Ej: 500mg'),

              _label("Margen de aviso a emergencia"),
              _buildGraciaDropdown(),
  ...
  void _guardarMedicamento() async {
    ...
    // Obtener el servicio desde el Provider (misma instancia que en otras pantallas)
